...
es_tasks = [
    ...
    ### Search task
    Task(operation=es_client.search_data, operation_kwargs=dict(filters={"name": "ame"})),

    ### Update task
    Task(operation=es_client.update_data, operation_kwargs=dict(filters={"name": "ame"}, update={"name": "ami"}, how="one")),

    ### Delete task
    Task(operation=es_client.delete_data, operation_kwargs=dict(filters={"name": "ami"}, how="one")),
]